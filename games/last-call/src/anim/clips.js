...
export const GUARD = {
  ...
  'head.y': 0.24, 'head.x': -0.10, 'head.z': 0.0,
  'shoulderL.y': 0.12, 'shoulderL.x': 0.0, 'shoulderL.z': 0.10,
  'shoulderR.y': -0.08, 'shoulderR.x': 0.0, 'shoulderR.z': -0.14,
...
def('idleGuard', {
  ...
  tracks: {
    ...
    'head.y': [[0, 0.24], [1.1, 0.28], [2.2, 0.21], [3.2, 0.24]],
...
def('idleDrunk', {
  ...
  tracks: {
    ...
    'head.y': [[0, 0.24], [1.2, 0.34], [2.8, 0.12], [4.6, 0.24]],
...
def('walk', {
  ...
  tracks: {
    ...
    'head.y': [[0, 0.22], [0.5, 0.28], [1.0, 0.22]]
  },
